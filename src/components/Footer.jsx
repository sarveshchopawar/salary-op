...
const Footer = () => {
    return (
        <section className="fixed left-0 bottom-0 w-full flex items-center justify-between px-4 py-3 border-t border-gray-50 bg-white">
            ...
            <NavLink to="/advance" className={({isActive})=>isActive&&"text-green-500"}>
                <div className="flex flex-col items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="currentColor" fill="none">
                    ...
                    <span className="text-[12px] font-medium">Advance</span>
                </div>
            </NavLink>
            <NavLink to="/addplace" className={({isActive})=> isActive && "text-green-500"}>
                <div className="flex flex-col items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="currentColor" fill="none">
                    ...
                    <span className="text-[12px] font-medium">Add place</span>
                </div>
            </NavLink>
        </section>
    );
